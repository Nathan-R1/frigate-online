var CREW_PRESETS = [
    {name:'Ambassador Kamar', type:'science', text_description:'You have the legal right to travel into People’s Star space.<b><c>Diplomacy</c></b>', combat_only:false, skill_increase:1},
    {name:'Arc Agent Tha’n', type:'science', text_description:'You have the legal right to travel into Vedlu space. <b><c>Leadership<c></b>', combat_only:false, skill_increase:1},
    {name:'Captain Janson', type:'science', text_description:'If you are scanned, you are notified and can respond with any known ship design.<b><c>Sensors</c></b>', combat_only:false, skill_increase:1},
    ...
    {name:'Conservative', type:'defense', text_description:'At the start of your turn, if you did not activate any “Offense” technologies, modules or deployables last round, gain 2 shields.', combat_only:true},
     {name:'Hoarding', type:'science', text_description:'+4 Storage', combat_only:false, skill_increase:1},
    ...
    {name:'Crew Munitions Assignment', type:'offense', text_description:'When you add 1 or more charges to a Technology, Module or Deployable you may add 1 additional. Take 1 penalty to any Crew Skill.', combat_only:true},
     ...
     {name:'Peace Loving', type:'science', text_description:'When you fail a Diplomacy check that would initiate combat, you may reroll once.', combat_only:false, skill_increase:1},
     ...
     {name:'Skittish', type:'movement', text_description:'During the Move phase, remove charges from a card to gain that many additional Speed for this turn.', combat_only:true},
    {name:'Sir Athruul', type:'movement', text_description:'After you complete your Move, you may Move 1 any asteroids which your Modules passed adjacent to.', combat_only:true},
         ...
         {name:'Watchful', type:'science', text_description:'Sensor range is calculated by 2 x Sensors plus Cyber', combat_only:true, skill_increase:1},
    ...
    {name:'Advancement', type:'science', combat_only:false, text_description:'+1 DC', skill_increase:1},
    {name:'Charge Conduit', type:'science', combat_only:true, text_description:'At the end of your turn, an ally within Sensor range gains 1 charge on one of their cards.'}
  ];
